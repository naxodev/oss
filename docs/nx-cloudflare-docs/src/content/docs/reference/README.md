...
Renames and re-exports [createCloudflareGenerator](/reference/functions/createcloudflaregenerator/)

***

### CloudflareApplicationGeneratorSchema

Renames and re-exports [CreateCloudflareGeneratorSchema](/reference/interfaces/createcloudflaregeneratorschema/)
