...
See the [introduction](/getting-started/introduction) for background on gonx's
nx-go origins.

## Before you start

- **Node.js 22+** (an active LTS release) and an Nx 23.x workspace
- **Go** — a [stable release](https://go.dev/dl/) (1.18+ for multi-module
  workspaces)

See [version compatibility](/getting-started/installation/#version-compatibility)
for supported Nx/gonx version pairs.
...
- [Migrate from nx-go to gonx](/community/migration) — coming from nx-go
