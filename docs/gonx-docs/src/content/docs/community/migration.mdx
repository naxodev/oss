---
title: Migrate from nx-go to gonx
description: How to migrate from nx-go or upgrade to @naxodev/gonx 4.x.
---

import { Steps } from '@astrojs/starlight/components';

gonx 4.x requires Nx 23 and infers Go targets from `go.mod` files instead of
...
1. **Upgrade to Nx 23**
   ...
   gonx 4.x requires Nx 23.x. If you are already on 23, skip this step.
