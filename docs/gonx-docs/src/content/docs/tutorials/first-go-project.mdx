...
- **Node.js 22+** and an **Nx 23.x** workspace
...
for supported Nx/gonx version pairs, and the
[introduction](/getting-started/introduction) for background on gonx's nx-go
origins.
